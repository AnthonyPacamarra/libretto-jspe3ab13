        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6" style="line-height: 35px;"> {{ $product->code }}
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" style="line-height: 35px;"> {{ $product->quantity }}
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6" style="line-height: 35px;"> {{ $product->description }}
                    </div>
                </div>
            </div>
        </div>
